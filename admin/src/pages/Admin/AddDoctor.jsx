...
const AddDoctor = () => {
    ...
    const [experience, setExperience] = useState('1 Tear')
    ...
    return (
        <form onSubmit={onSubmitHandler} className='m-5 w-full'>
            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div>
                    <p className='mt-4 mb-2 text-gray-500'>About Dctor</p>
